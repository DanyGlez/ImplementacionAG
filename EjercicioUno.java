...
public class EjercicioUno {
    public static float[] vecPadre = new float[10];
    public static float[] vecMadre = new float[10];
    public static float[] fitnessPadre = new float[10];
    public static float[] fitnessMadre = new float[10];
    public static float[] Ganadores = new float[10];
    public static int Poblacion = 9;
...
public static void main(String[] args) {    
    ...
    public static void inicializarPoblacion() {
        if (aux <= Poblacion) {
            vecPadre[aux] = (float) (Math.random()*10); 
            vecMadre[aux] = (float) (Math.random()*10); 
            aux++;
            inicializarPoblacion();
        }
    }
